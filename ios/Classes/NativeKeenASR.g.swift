...
protocol NativeKeenASR {
  ...
  func createDecodingGraphFromPhrases(phrases: [String], speakingTask: NativeSpeakingTask, name: String, alternativePronunciations: [NativeAlternativePronunciation], spokenNoiseProbability: Double, completion: @escaping (Result<Bool, Error>) -> Void)
  func createContextualDecodingGraphFromPhrases(contextualPhrases: [[String]], speakingTask: NativeSpeakingTask, name: String, alternativePronunciations: [NativeAlternativePronunciation], spokenNoiseProbability: Double, completion: @escaping (Result<Bool, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NativeKeenASR?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      createDecodingGraphFromPhrasesChannel.setMessageHandler { message, reply in
        ...
        let spokenNoiseProbabilityArg = args[4] as! Double
        api.createDecodingGraphFromPhrases(phrases: phrasesArg, speakingTask: speakingTaskArg, name: nameArg, alternativePronunciations: alternativePronunciationsArg, spokenNoiseProbability: spokenNoiseProbabilityArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    if let api = api {
      createContextualDecodingGraphFromPhrasesChannel.setMessageHandler { message, reply in
        ...
        let alternativePronunciationsArg = args[3] as! [NativeAlternativePronunciation]
        let spokenNoiseProbabilityArg = args[4] as! Double
        api.createContextualDecodingGraphFromPhrases(contextualPhrases: contextualPhrasesArg, speakingTask: speakingTaskArg, name: nameArg, alternativePronunciations: alternativePronunciationsArg, spokenNoiseProbability: spokenNoiseProbabilityArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
