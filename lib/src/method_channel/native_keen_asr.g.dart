...
class NativeKeenASR {
  ...
  Future<bool> createDecodingGraphFromPhrases(List<String> phrases, NativeSpeakingTask speakingTask, String name, List<NativeAlternativePronunciation> alternativePronunciations, double spokenNoiseProbability) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[phrases, speakingTask, name, alternativePronunciations, spokenNoiseProbability]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
  ...
  Future<bool> createContextualDecodingGraphFromPhrases(List<List<String>> contextualPhrases, NativeSpeakingTask speakingTask, String name, List<NativeAlternativePronunciation> alternativePronunciations, double spokenNoiseProbability) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[contextualPhrases, speakingTask, name, alternativePronunciations, spokenNoiseProbability]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
