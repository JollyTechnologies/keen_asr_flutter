...
interface NativeKeenASR {
  ...
  fun createDecodingGraphFromPhrases(phrases: List<String>, speakingTask: NativeSpeakingTask, name: String, alternativePronunciations: List<NativeAlternativePronunciation>, spokenNoiseProbability: Double, callback: (Result<Boolean>) -> Unit)
  fun createContextualDecodingGraphFromPhrases(contextualPhrases: List<List<String>>, speakingTask: NativeSpeakingTask, name: String, alternativePronunciations: List<NativeAlternativePronunciation>, spokenNoiseProbability: Double, callback: (Result<Boolean>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val spokenNoiseProbabilityArg = args[4] as Double
            api.createDecodingGraphFromPhrases(phrasesArg, speakingTaskArg, nameArg, alternativePronunciationsArg, spokenNoiseProbabilityArg) { result: Result<Boolean> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NativeKeenASRPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val alternativePronunciationsArg = args[3] as List<NativeAlternativePronunciation>
            val spokenNoiseProbabilityArg = args[4] as Double
            api.createContextualDecodingGraphFromPhrases(contextualPhrasesArg, speakingTaskArg, nameArg, alternativePronunciationsArg, spokenNoiseProbabilityArg) { result: Result<Boolean> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(NativeKeenASRPigeonUtils.wrapError(error))
              } else {
